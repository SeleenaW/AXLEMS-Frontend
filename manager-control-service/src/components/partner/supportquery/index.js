...
const SupportQuery = () => {
  ...
  const inquiryTypes = [
    ...
    { value: "Booking and Inventory Support", label: "Booking and Inventory Support" },
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-md bg-white shadow-md rounded px-8 pt-6 pb-8">
        <h1 className="text-2xl font-semibold text-gray-700 mb-10">Submit a Support Query</h1>
        <Formik
          initialValues={{
            vendorName: "",
            vendorId: "",
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                {errors.vendorName && touched.vendorName && (
                  <div className="text-red-500 text-xs italic">{errors.vendorName}</div>
                )}
              </div>
              ...
              <div className="mb-4">
                ...
                {errors.contactPerson && touched.contactPerson && (
                  <div className="text-red-500 text-xs italic">{errors.contactPerson}</div>
                )}
              </div>
              ...
              <div className="mb-4">
                ...
                {errors.phoneNumber && touched.phoneNumber && (
                  <div className="text-red-500 text-xs italic">{errors.phoneNumber}</div>
                )}
              </div>
              ...
              <div className="mb-4">
                ...
                {errors.subject && touched.subject && (
                  <div className="text-red-500 text-xs italic">{errors.subject}</div>
                )}
              </div>
              ...
              <div className="mb-4">
                ...
                <Select
                  ...
                  onChange={(option) => setFieldValue("inquiryType", option.value)}
                  onBlur={handleBlur}
                  value={inquiryTypes.find((type) => type.value === values.inquiryType)}
                />
                {errors.inquiryType && touched.inquiryType && (
                  <div className="text-red-500 text-xs italic">{errors.inquiryType}</div>
                )}
              </div>
              ...
              <div className="mb-4">
                ...
                {errors.message && touched.message && (
                  <div className="text-red-500 text-xs italic">{errors.message}</div>
                )}
              </div>
              ...
              <div className="mb-4">
                ...
                <Select
                  ...
                  onChange={(option) => setFieldValue("urgencyLevel", option.value)}
                  onBlur={handleBlur}
                  value={urgencyLevels.find((level) => level.value === values.urgencyLevel)}
                />
                {errors.urgencyLevel && touched.urgencyLevel && (
                  <div className="text-red-500 text-xs italic">{errors.urgencyLevel}</div>
                )}
              </div>

              {/* Attachments */}
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2">Attachment (File Path)</label>
                <input
                  className="shadow border rounded w-full py-2 px-3 text-gray-700"
                  type="text"
                  name="attachments"
                ...
                {errors.attachments && touched.attachments && (
                  <div className="text-red-500 text-xs italic">{errors.attachments}</div>
                )}
              </div>
